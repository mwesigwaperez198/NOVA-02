					...
					<table id="example1" class="table table-bordered table-hover table-striped">
						<thead>
							<tr>
								...
								<th width="180">Country, City, Contacts</th>
								<th>Status</th>
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr class="<?php if($row['cust_status']==1) {echo 'bg-g';}else {echo 'bg-r';} ?>">
									<td><?php echo $i; ?></td>
									<td><?php echo htmlspecialchars($row['cust_name'], ENT_QUOTES, 'UTF-8'); ?></td>
									<td><?php echo htmlspecialchars($row['cust_email'], ENT_QUOTES, 'UTF-8'); ?></td>
									<td>
										<?php echo htmlspecialchars($row['country_name'], ENT_QUOTES, 'UTF-8'); ?><br>
										<?php echo htmlspecialchars($row['cust_city'], ENT_QUOTES, 'UTF-8'); ?><br>
										<?php echo htmlspecialchars($row['cust_phone'], ENT_QUOTES, 'UTF-8'); ?>
									</td>
